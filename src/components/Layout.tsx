...
export const Layout = ({ children, notes }: LayoutType) => {
  return (
    <div className='flex flex-col text-base md:h-screen md:space-y-0 md:flex-row font-regular font-typeface tracking-base'>
      <Sidebar 
        notes={notes} 
        wrapperClassName='fixed z-50 w-full px-4 mt-2 md:mt-0 lg:pt-8 md:py-8 md:pl-8 md:pr-16 min-w-min md:w-1/6'
        className='max-w-2xl mx-auto md:mx-0 md:max-w-sm'
      />
